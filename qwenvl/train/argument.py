...
class ModelArguments:
    ...
    all_ttt_layers: str = field(default="0")
    pretrained_ttt_layers: str = field(default="-1")
    global_factor: float = field(default=0.0)
    loss_factor: float = field(default=0.0)
    savemode_stoplayer: int = field(default=0)
    shrinksize: int = field(default=0)
    shrinksize_config: str = field(default="")
...
class DataArguments:
    ...
    total_timestamps: int = field(default=5000)
