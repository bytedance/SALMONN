...
1. Our environment: The python version is 3.9.17, and other required packages can be installed with the following command: ```pip3 install soundfile librosa torch==2.0.1 transformers==4.28.0 peft==0.3.0```.
