...
from .half_freeze_module import HalfFreezeEmbedding, HalfFreezeLinear
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def add_learnable_embeddings(self, emb_num):
        new_embed_tokens = HalfFreezeEmbedding(self.model.embed_tokens.weight, emb_num)
        new_lm_head = HalfFreezeLinear(self.lm_head, emb_num)
        self.model.embed_tokens = new_embed_tokens
        self.lm_head = new_lm_head
        self.config.vocab_size += emb_num
    ...
    def forward(
        ...
        cache_position: Optional[torch.LongTensor] = None,
        inv_targets_v2 = None,
        return_chosen_loss = False,
        return_gt_loss = False,
