...
from llava.model import videoSALMONNo1ForCausalLM
...
def load_qwen_lora_model(
    ...
    **audio_config
    ...
    model = videoSALMONNo1ForCausalLM.from_pretrained(model_base, config=cfg_pretrained, cache_dir=None, attn_implementation="flash_attention_2", torch_dtype=(torch.bfloat16), **audio_config)
